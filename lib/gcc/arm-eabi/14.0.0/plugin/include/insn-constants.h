...
enum unspec {
  ...
  VRSHRNTQ_M_N_S = 956,
  VQRDMULHQ_M_N_S = 957,
  VRMLALDAVHAQ_P_S = 958,
  VMLSLDAVAQ_P_S = 959,
  VMLSLDAVAXQ_P_S = 960,
  VMULLBQ_POLY_M_P = 961,
  VMULLTQ_POLY_M_P = 962,
  VQDMULLBQ_M_N_S = 963,
  VQDMULLBQ_M_S = 964,
  VQDMULLTQ_M_N_S = 965,
  VQDMULLTQ_M_S = 966,
  VQRSHRUNBQ_M_N_S = 967,
  VQSHRUNBQ_M_N_S = 968,
  VQSHRUNTQ_M_N_S = 969,
  VRMLALDAVHAQ_P_U = 970,
  VRMLALDAVHAXQ_P_S = 971,
  VRMLSLDAVHAQ_P_S = 972,
  VRMLSLDAVHAXQ_P_S = 973,
  VQRSHRUNTQ_M_N_S = 974,
  VCMLAQ_M_F = 975,
  VCMLAQ_ROT180_M_F = 976,
  VCMLAQ_ROT270_M_F = 977,
  VCMLAQ_ROT90_M_F = 978,
  VCMULQ_M_F = 979,
  VCMULQ_ROT180_M_F = 980,
  VCMULQ_ROT270_M_F = 981,
  VCMULQ_ROT90_M_F = 982,
  VFMAQ_M_F = 983,
  VFMAQ_M_N_F = 984,
  VFMASQ_M_N_F = 985,
  VFMSQ_M_F = 986,
