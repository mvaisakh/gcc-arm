...
enum opt_code
{
  ...
  OPT_mapcs = 1760,                          /* -mapcs */
  OPT_mapcs_frame = 1761,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1762,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1763,              /* -mapcs-stack-check */
  OPT_march_ = 1764,                         /* -march= */
  OPT_marm = 1765,                           /* -marm */
  OPT_masm_syntax_unified = 1766,            /* -masm-syntax-unified */
  OPT_mbe32 = 1767,                          /* -mbe32 */
  OPT_mbe8 = 1768,                           /* -mbe8 */
  OPT_mbig_endian = 1769,                    /* -mbig-endian */
  OPT_mbranch_cost_ = 1770,                  /* -mbranch-cost= */
  OPT_mcallee_super_interworking = 1771,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1772,     /* -mcaller-super-interworking */
  OPT_mcmse = 1773,                          /* -mcmse */
  OPT_mcpu_ = 1774,                          /* -mcpu= */
  OPT_mfdpic = 1775,                         /* -mfdpic */
  OPT_mfix_cmse_cve_2021_35465 = 1776,       /* -mfix-cmse-cve-2021-35465 */
  OPT_mfix_cortex_m3_ldrd = 1777,            /* -mfix-cortex-m3-ldrd */
  OPT_mflip_thumb = 1778,                    /* -mflip-thumb */
  OPT_mfloat_abi_ = 1779,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1780,                  /* -mfp16-format= */
  OPT_mfpu_ = 1781,                          /* -mfpu= */
  OPT_mgeneral_regs_only = 1782,             /* -mgeneral-regs-only */
  /* OPT_mhard_float = 1783, */              /* -mhard-float */
  OPT_mlibarch_ = 1784,                      /* -mlibarch= */
  OPT_mlittle_endian = 1785,                 /* -mlittle-endian */
  OPT_mlong_calls = 1786,                    /* -mlong-calls */
  OPT_mneon_for_64bits = 1787,               /* -mneon-for-64bits */
  OPT_mpic_data_is_text_relative = 1788,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1789,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1790,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1791,               /* -mprint-tune-info */
  OPT_mpure_code = 1792,                     /* -mpure-code */
  OPT_mrestrict_it = 1793,                   /* -mrestrict-it */
  OPT_msched_prolog = 1794,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1795,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1796,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1797, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1798,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1799,                         /* -mthumb */
  OPT_mthumb_interwork = 1800,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1801,                  /* -mtls-dialect= */
  OPT_mtp_ = 1802,                           /* -mtp= */
  OPT_mtpcs_frame = 1803,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1804,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1805,                         /* -mtune= */
  OPT_munaligned_access = 1806,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1807,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1808,      /* -mvectorize-with-neon-quad */
  OPT_mverbose_cost_dump = 1809,             /* -mverbose-cost-dump */
  OPT_mword_relocations = 1810,              /* -mword-relocations */
  OPT_n = 1811,                              /* -n */
