...
enum opt_code
{
  ...
  OPT_frust_crate_ = 1570,                   /* -frust-crate= */
  OPT_frust_debug = 1571,                    /* -frust-debug */
  OPT_frust_dump_ = 1572,                    /* -frust-dump- */
  OPT_frust_edition_ = 1573,                 /* -frust-edition= */
  OPT_frust_embed_metadata = 1574,           /* -frust-embed-metadata */
  OPT_frust_incomplete_and_experimental_compiler_do_not_use = 1575,/* -frust-incomplete-and-experimental-compiler-do-not-use */
  OPT_frust_mangling_ = 1576,                /* -frust-mangling= */
  OPT_frust_max_recursion_depth_ = 1577,     /* -frust-max-recursion-depth= */
  OPT_frust_metadata_output_ = 1578,         /* -frust-metadata-output= */
  OPT_fsanitize_address_use_after_scope = 1579,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_ = 1580,            /* -fsanitize-coverage= */
  OPT_fsanitize_recover = 1581,              /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 1582,             /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 1583,            /* -fsanitize-sections= */
  OPT_fsanitize_trap = 1584,                 /* -fsanitize-trap */
  OPT_fsanitize_trap_ = 1585,                /* -fsanitize-trap= */
  /* OPT_fsanitize_undefined_trap_on_error = 1586, *//* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 1587,                     /* -fsanitize= */
  OPT_fsave_mixins_ = 1588,                  /* -fsave-mixins= */
  OPT_fsave_optimization_record = 1589,      /* -fsave-optimization-record */
  OPT_fscaffold_c = 1590,                    /* -fscaffold-c */
  OPT_fscaffold_c__ = 1591,                  /* -fscaffold-c++ */
  OPT_fscaffold_dynamic = 1592,              /* -fscaffold-dynamic */
  OPT_fscaffold_main = 1593,                 /* -fscaffold-main */
  OPT_fscaffold_static = 1594,               /* -fscaffold-static */
  OPT_fsched_critical_path_heuristic = 1595, /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 1596,     /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 1597,         /* -fsched-group-heuristic */
  OPT_fsched_interblock = 1598,              /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 1599,     /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 1600,                /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 1601,          /* -fsched-rank-heuristic */
  OPT_fsched_spec = 1602,                    /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 1603,     /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 1604,               /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 1605,     /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 1606,           /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 1607,       /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 1608,      /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 1609,          /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 1610,                /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 1611,        /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 1612, */       /* -fsched2-use-traces */
  OPT_fschedule_fusion = 1613,               /* -fschedule-fusion */
  OPT_fschedule_insns = 1614,                /* -fschedule-insns */
  OPT_fschedule_insns2 = 1615,               /* -fschedule-insns2 */
  OPT_fsecond_underscore = 1616,             /* -fsecond-underscore */
  OPT_fsection_anchors = 1617,               /* -fsection-anchors */
  /* OPT_fsee = 1618, */                     /* -fsee */
  OPT_fsel_sched_pipelining = 1619,          /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 1620,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 1621,/* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 1622,          /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 1623,         /* -fselective-scheduling2 */
  OPT_fself_test_ = 1624,                    /* -fself-test= */
  OPT_fsemantic_interposition = 1625,        /* -fsemantic-interposition */
  OPT_fshared = 1626,                        /* -fshared */
  OPT_fshort_enums = 1627,                   /* -fshort-enums */
  OPT_fshort_wchar = 1628,                   /* -fshort-wchar */
  OPT_fshow_column = 1629,                   /* -fshow-column */
  OPT_fshrink_wrap = 1630,                   /* -fshrink-wrap */
  OPT_fshrink_wrap_separate = 1631,          /* -fshrink-wrap-separate */
  OPT_fsign_zero = 1632,                     /* -fsign-zero */
  OPT_fsignaling_nans = 1633,                /* -fsignaling-nans */
  OPT_fsigned_bitfields = 1634,              /* -fsigned-bitfields */
  OPT_fsigned_char = 1635,                   /* -fsigned-char */
  OPT_fsigned_zeros = 1636,                  /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 1637,              /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 1638,     /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 1639,            /* -fsized-deallocation */
  OPT_fsoft_check_all = 1640,                /* -fsoft-check-all */
  OPT_fsources = 1641,                       /* -fsources */
  OPT_fsplit_ivs_in_unroller = 1642,         /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 1643,                   /* -fsplit-loops */
  OPT_fsplit_paths = 1644,                   /* -fsplit-paths */
  OPT_fsplit_stack = 1645,                   /* -fsplit-stack */
  OPT_fsplit_wide_types = 1646,              /* -fsplit-wide-types */
  OPT_fsplit_wide_types_early = 1647,        /* -fsplit-wide-types-early */
  OPT_fsquangle = 1648,                      /* -fsquangle */
  OPT_fssa_backprop = 1649,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1650,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1651,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1652,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1653, */             /* -fstack-check */
  OPT_fstack_check_ = 1654,                  /* -fstack-check= */
  OPT_fstack_clash_protection = 1655,        /* -fstack-clash-protection */
  OPT_fstack_limit = 1656,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1657,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1658,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1659,               /* -fstack-protector */
  OPT_fstack_protector_all = 1660,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1661,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1662,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1663,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1664,                   /* -fstack-usage */
  OPT_fstats = 1665,                         /* -fstats */
  OPT_fstdarg_opt = 1666,                    /* -fstdarg-opt */
  OPT_fstore_merging = 1667,                 /* -fstore-merging */
  /* OPT_fstrength_reduce = 1668, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1669,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1670,                  /* -fstrict-enums */
  /* OPT_fstrict_flex_arrays = 1671, */      /* -fstrict-flex-arrays */
  OPT_fstrict_flex_arrays_ = 1672,           /* -fstrict-flex-arrays= */
  OPT_fstrict_overflow = 1673,               /* -fstrict-overflow */
  OPT_fstrict_prototype = 1674,              /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1675,     /* -fstrict-volatile-bitfields */
  /* OPT_fstrong_eval_order = 1676, */       /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 1677,            /* -fstrong-eval-order= */
  OPT_fswig = 1678,                          /* -fswig */
  OPT_fswitch_errors = 1679,                 /* -fswitch-errors */
  OPT_fsync_libcalls = 1680,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1681,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1682,                      /* -ftabstop= */
  /* OPT_ftail_call_workaround = 1683, */    /* -ftail-call-workaround */
  OPT_ftail_call_workaround_ = 1684,         /* -ftail-call-workaround= */
  /* OPT_ftarget_help = 1685, */             /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 1686,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1687, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1688,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1689,                 /* -ftest-coverage */
  OPT_ftest_forall_temp = 1690,              /* -ftest-forall-temp */
  OPT_fthis_is_variable = 1691,              /* -fthis-is-variable */
  OPT_fthread_jumps = 1692,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1693,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1694,                   /* -ftime-report */
  OPT_ftime_report_details = 1695,           /* -ftime-report-details */
  OPT_ftls_model_ = 1696,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1697,              /* -ftoplevel-reorder */
  OPT_ftracer = 1698,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1699,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1700,        /* -ftrack-macro-expansion= */
  OPT_ftrampolines = 1701,                   /* -ftrampolines */
  OPT_ftransition_all = 1702,                /* -ftransition=all */
  OPT_ftransition_field = 1703,              /* -ftransition=field */
  OPT_ftransition_in = 1704,                 /* -ftransition=in */
  OPT_ftransition_nogc = 1705,               /* -ftransition=nogc */
  OPT_ftransition_templates = 1706,          /* -ftransition=templates */
  OPT_ftransition_tls = 1707,                /* -ftransition=tls */
  OPT_ftrapping_math = 1708,                 /* -ftrapping-math */
  OPT_ftrapv = 1709,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1710,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1711,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1712,                      /* -ftree-ccp */
  OPT_ftree_ch = 1713,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1714, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1715,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1716,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1717, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1718,                   /* -ftree-cselim */
  OPT_ftree_dce = 1719,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1720,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1721,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1722,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1723,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1724, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1725,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1726,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 1727, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1728,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1729,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1730, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1731,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1732,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1733,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1734,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1735,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1736,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1737,                      /* -ftree-pre */
  OPT_ftree_pta = 1738,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1739,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1740, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1741,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1742,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1743,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1744,                     /* -ftree-slsr */
  OPT_ftree_sra = 1745,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1746, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1747, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1748,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1749,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1750,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1751, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1752,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1753, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1754,                      /* -ftree-vrp */
  OPT_ftrivial_auto_var_init_ = 1755,        /* -ftrivial-auto-var-init= */
  OPT_funbounded_by_reference = 1756,        /* -funbounded-by-reference */
  OPT_funconstrained_commons = 1757,         /* -funconstrained-commons */
  OPT_funderscoring = 1758,                  /* -funderscoring */
  OPT_funit_at_a_time = 1759,                /* -funit-at-a-time */
  OPT_funittest = 1760,                      /* -funittest */
  OPT_funreachable_traps = 1761,             /* -funreachable-traps */
  OPT_funroll_all_loops = 1762,              /* -funroll-all-loops */
  OPT_funroll_completely_grow_size = 1763,   /* -funroll-completely-grow-size */
  OPT_funroll_loops = 1764,                  /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 1765, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1766,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1767,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1768,                 /* -funsigned-char */
  OPT_funswitch_loops = 1769,                /* -funswitch-loops */
  OPT_funwind_tables = 1770,                 /* -funwind-tables */
  OPT_fuse_cxa_atexit = 1771,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1772,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 1773,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1774,                   /* -fuse-ld=gold */
  OPT_fuse_ld_lld = 1775,                    /* -fuse-ld=lld */
  OPT_fuse_ld_mold = 1776,                   /* -fuse-ld=mold */
  OPT_fuse_linker_plugin = 1777,             /* -fuse-linker-plugin */
  OPT_fuse_list_ = 1778,                     /* -fuse-list= */
  OPT_fvar_tracking = 1779,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1780,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1781,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1782,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1783,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1784, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1785,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1786,                   /* -fverbose-asm */
  /* OPT_fversion = 1787, */                 /* -fversion */
  OPT_fversion_loops_for_strides = 1788,     /* -fversion-loops-for-strides */
  OPT_fversion_ = 1789,                      /* -fversion= */
  OPT_fvisibility_inlines_hidden = 1790,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1791,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1792,                   /* -fvisibility= */
  OPT_fvpt = 1793,                           /* -fvpt */
  OPT_fvtable_gc = 1794,                     /* -fvtable-gc */
  OPT_fvtable_thunks = 1795,                 /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1796,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1797,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1798,                     /* -fvtv-debug */
  OPT_fweak = 1799,                          /* -fweak */
  OPT_fweak_templates = 1800,                /* -fweak-templates */
  OPT_fweb = 1801,                           /* -fweb */
  /* OPT_fwhole_file = 1802, */              /* -fwhole-file */
  OPT_fwhole_program = 1803,                 /* -fwhole-program */
  OPT_fwholediv = 1804,                      /* -fwholediv */
  OPT_fwholevalue = 1805,                    /* -fwholevalue */
  OPT_fwide_exec_charset_ = 1806,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1807,             /* -fworking-directory */
  OPT_fwpa = 1808,                           /* -fwpa */
  OPT_fwpa_ = 1809,                          /* -fwpa= */
  OPT_fwrapv = 1810,                         /* -fwrapv */
  OPT_fwrapv_pointer = 1811,                 /* -fwrapv-pointer */
  OPT_fxref = 1812,                          /* -fxref */
  /* OPT_fzee = 1813, */                     /* -fzee */
  OPT_fzero_call_used_regs_ = 1814,          /* -fzero-call-used-regs= */
  OPT_fzero_initialized_in_bss = 1815,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1816,                     /* -fzero-link */
  OPT_g = 1817,                              /* -g */
  OPT_gant = 1818,                           /* -gant */
  OPT_gas_loc_support = 1819,                /* -gas-loc-support */
  OPT_gas_locview_support = 1820,            /* -gas-locview-support */
  OPT_gbtf = 1821,                           /* -gbtf */
  OPT_gcoff = 1822,                          /* -gcoff */
  OPT_gcoff1 = 1823,                         /* -gcoff1 */
  OPT_gcoff2 = 1824,                         /* -gcoff2 */
  OPT_gcoff3 = 1825,                         /* -gcoff3 */
  OPT_gcolumn_info = 1826,                   /* -gcolumn-info */
  OPT_gctf = 1827,                           /* -gctf */
  OPT_gdescribe_dies = 1828,                 /* -gdescribe-dies */
  OPT_gdwarf = 1829,                         /* -gdwarf */
  OPT_gdwarf_ = 1830,                        /* -gdwarf- */
  OPT_gdwarf32 = 1831,                       /* -gdwarf32 */
  OPT_gdwarf64 = 1832,                       /* -gdwarf64 */
  OPT_gen_decls = 1833,                      /* -gen-decls */
  OPT_ggdb = 1834,                           /* -ggdb */
  OPT_ggnu_pubnames = 1835,                  /* -ggnu-pubnames */
  OPT_gimple_stats = 1836,                   /* -gimple-stats */
  OPT_ginline_points = 1837,                 /* -ginline-points */
  OPT_ginternal_reset_location_views = 1838, /* -ginternal-reset-location-views */
  OPT_gnat = 1839,                           /* -gnat */
  OPT_gnatO = 1840,                          /* -gnatO */
  OPT_gno_ = 1841,                           /* -gno- */
  OPT_gno_pubnames = 1842,                   /* -gno-pubnames */
  OPT_gpubnames = 1843,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1844,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1845,                   /* -gsplit-dwarf */
  OPT_gstabs = 1846,                         /* -gstabs */
  OPT_gstabs_ = 1847,                        /* -gstabs+ */
  OPT_gstatement_frontiers = 1848,           /* -gstatement-frontiers */
  OPT_gstrict_dwarf = 1849,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1850,                        /* -gtoggle */
  OPT_gvariable_location_views = 1851,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 1852,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 1853,                           /* -gvms */
  OPT_gxcoff = 1854,                         /* -gxcoff */
  OPT_gxcoff_ = 1855,                        /* -gxcoff+ */
  OPT_gz = 1856,                             /* -gz */
  OPT_gz_ = 1857,                            /* -gz= */
  OPT_h = 1858,                              /* -h */
  OPT_help = 1859,                           /* -help */
  OPT_idirafter = 1860,                      /* -idirafter */
  OPT_imacros = 1861,                        /* -imacros */
  OPT_imultiarch = 1862,                     /* -imultiarch */
  OPT_imultilib = 1863,                      /* -imultilib */
  OPT_include = 1864,                        /* -include */
  OPT_iplugindir_ = 1865,                    /* -iplugindir= */
  OPT_iprefix = 1866,                        /* -iprefix */
  OPT_iquote = 1867,                         /* -iquote */
  OPT_isysroot = 1868,                       /* -isysroot */
  OPT_isystem = 1869,                        /* -isystem */
  OPT_iwithprefix = 1870,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1871,              /* -iwithprefixbefore */
  OPT_k8 = 1872,                             /* -k8 */
  OPT_l = 1873,                              /* -l */
  OPT_lang_asm = 1874,                       /* -lang-asm */
  OPT_list = 1875,                           /* -list */
  OPT_mabi_ = 1876,                          /* -mabi= */
  OPT_mabort_on_noreturn = 1877,             /* -mabort-on-noreturn */
  OPT_mapcs = 1878,                          /* -mapcs */
  OPT_mapcs_frame = 1879,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1880,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1881,              /* -mapcs-stack-check */
  OPT_march_ = 1882,                         /* -march= */
  OPT_marm = 1883,                           /* -marm */
  OPT_masm_syntax_unified = 1884,            /* -masm-syntax-unified */
  OPT_mbe32 = 1885,                          /* -mbe32 */
  OPT_mbe8 = 1886,                           /* -mbe8 */
  OPT_mbig_endian = 1887,                    /* -mbig-endian */
  OPT_mbranch_cost_ = 1888,                  /* -mbranch-cost= */
  OPT_mcallee_super_interworking = 1889,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1890,     /* -mcaller-super-interworking */
  OPT_mcmse = 1891,                          /* -mcmse */
  OPT_mcpu_ = 1892,                          /* -mcpu= */
  OPT_mfdpic = 1893,                         /* -mfdpic */
  OPT_mfix_cmse_cve_2021_35465 = 1894,       /* -mfix-cmse-cve-2021-35465 */
  OPT_mfix_cortex_a57_aes_1742098 = 1895,    /* -mfix-cortex-a57-aes-1742098 */
  /* OPT_mfix_cortex_a72_aes_1655431 = 1896, *//* -mfix-cortex-a72-aes-1655431 */
  OPT_mfix_cortex_m3_ldrd = 1897,            /* -mfix-cortex-m3-ldrd */
  OPT_mflip_thumb = 1898,                    /* -mflip-thumb */
  OPT_mfloat_abi_ = 1899,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1900,                  /* -mfp16-format= */
  OPT_mfpu_ = 1901,                          /* -mfpu= */
  OPT_mgeneral_regs_only = 1902,             /* -mgeneral-regs-only */
  /* OPT_mhard_float = 1903, */              /* -mhard-float */
  OPT_mlibarch_ = 1904,                      /* -mlibarch= */
  OPT_mlittle_endian = 1905,                 /* -mlittle-endian */
  OPT_mlong_calls = 1906,                    /* -mlong-calls */
  OPT_mneon_for_64bits = 1907,               /* -mneon-for-64bits */
  OPT_mpic_data_is_text_relative = 1908,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1909,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1910,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1911,               /* -mprint-tune-info */
  OPT_mpure_code = 1912,                     /* -mpure-code */
  OPT_mrestrict_it = 1913,                   /* -mrestrict-it */
  OPT_msched_prolog = 1914,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1915,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1916,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1917, */              /* -msoft-float */
  OPT_mstack_protector_guard_offset_ = 1918, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_ = 1919,        /* -mstack-protector-guard= */
  OPT_mstructure_size_boundary_ = 1920,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1921,                         /* -mthumb */
  OPT_mthumb_interwork = 1922,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1923,                  /* -mtls-dialect= */
  OPT_mtp_ = 1924,                           /* -mtp= */
  OPT_mtpcs_frame = 1925,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1926,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1927,                         /* -mtune= */
  OPT_munaligned_access = 1928,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1929,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1930,      /* -mvectorize-with-neon-quad */
  OPT_mverbose_cost_dump = 1931,             /* -mverbose-cost-dump */
  OPT_mword_relocations = 1932,              /* -mword-relocations */
  OPT_n = 1933,                              /* -n */
